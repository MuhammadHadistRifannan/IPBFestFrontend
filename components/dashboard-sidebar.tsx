...
function SidebarButton({
  ...
  const buttonEl = (
    <button
      ...
      className={cn(
        "flex h-12 items-center gap-3 transition-all duration-300 relative group rounded-2xl justify-start pl-3.5",
      ...
      <span
        className={cn(
          ...
          collapsed
            ...
            : "max-w-37.5 opacity-100 transition-[max-width,opacity] duration-300"
        )}
      >
        {label}
      </span>
